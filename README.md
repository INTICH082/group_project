...
- 📝 В планах: 0 модуль
- ⚙️ Тестирование и доработка: 4 модуль
---
...
| **Веб-клиент** | React, JavaScript | Первых Д. | ⚙️ **Тестирование и доработка** | ![](https://geps.dev/progress/70?dangerColor=800000&warningColor=ff9900&successColor=006600) |
| **Telegram бот** | Python, aiogram | Князев Р. | ⚙️ **Тестирование и доработка** | ![](https://geps.dev/progress/90?dangerColor=800000&warningColor=ff9900&successColor=006600) |
