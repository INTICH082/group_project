...
**Статус:**
- ✅ Завершено: 0 модулей
- 🔄 В разработке: 1 модуля
- 📝 В планах: 0 модуль
- ⚙️ Тестирование и доработка: 1 модуль
---
...
| **Веб-клиент** | React, JavaScript | Первых Д. | 📝 **Тестирование и доработка** | ![](https://geps.dev/progress/70?dangerColor=800000&warningColor=ff9900&successColor=006600) |
| **Telegram бот** | Python, aiogram | Князев Р. | 🔄 **Тестирование и доработка** | ![](https://geps.dev/progress/90?dangerColor=800000&warningColor=ff9900&successColor=006600) |
| **Авторизация** | C++, OAuth, JWT | Липко О. | 🔄 **Тестирование и доработка** | ![](https://geps.dev/progress/80?dangerColor=800000&warningColor=ff9900&successColor=006600) |
